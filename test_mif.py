...
MODEL_PATH = "Checkpoint/MIF.pth"
FOLDER1 = "Testset/MIF/PET"  # Path to folder PET
FOLDER2 = "Testset/MIF/MRI"  # Path to folder MRI
OUTPUT_FOLDER = "Results/MIF"  # Output folder path
...
color.convert_gray_folder_to_rgb(
    gray_folder=OUTPUT_FOLDER,
    reference_folder=FOLDER1,
