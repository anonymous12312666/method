...
MODEL_PATH = "Checkpoint/VIF.pth"
FOLDER1 = "Testset/VIF/VIS"  # Path to folder VIS
FOLDER2 = "Testset/VIF/IR"  # Path to folder IR
OUTPUT_FOLDER = "Results/VIF"  # Output folder path
